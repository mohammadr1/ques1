...
<div class="panel width1020" dir="rtl" style="text-align: right; margin-top: 10px;">
    <div class="partie_gauche element">
      <div>فروشگاهی</div>
      <ul>
        <li class="active"><a href=""><i class="fa fa-shopping-basket pl-2"></i><span>ایجاد فروشگاه جدید</span></a></li>
        <li><a href=""><i class="fa fa-list-alt pl-2"></i><span>دسته بندی ها</span></a></li>
